    ...
    <div className="-my-8 divide-y-2 divide-gray-800">
      <div className="py-8 flex flex-wrap md:flex-nowrap">
        <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
          <span className="font-semibold title-font text-white">SESSION</span>
          <span className="mt-1 text-gray-500 text-sm">NOV- 2021 to MAY-2025</span>
        </div>
      ...
      <div className="py-8 flex border-t-2 border-gray-800 flex-wrap md:flex-nowrap">
        <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
          <span className="font-semibold title-font text-white">SESSION</span>
          <span className="mt-1 text-gray-500 text-sm">MAR-2017 to MAR-2019</span>
        </div>
        <div className="md:flex-grow">
      ...
      <div className="py-8 flex border-t-2 border-gray-800 flex-wrap md:flex-nowrap">
        <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
          <span className="font-semibold title-font text-white">SESSION</span>
          <span className="mt-1 text-gray-500 text-sm">MAR 2007 to MAR-2017</span>
        </div>
        <div className="md:flex-grow">
          <h2 className="text-2xl font-bold text-white title-font mb-2">Kendriya Vidyalaya, ONGC Nazira</h2>
